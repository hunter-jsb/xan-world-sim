	...
	return []helpNode{
		...
		{title: "systems", children: []helpNode{
			...
			{title: "rock & fire — the living geology", body: []string{
				...
				"the same mountain blows at the same moment, every time.",
				"",
				...
				"",
				"every cell's surface rock and age live in the geological lens and the",
				"cursor line — alluvium is always young (the river reworks it), the",
				"shield is always ancient, and bold marks ground the ice or fire just left.",
			}},
